          ...
          render: function (data, type, row, meta) {
            ...
            for (var i in row.objetivos) {
              if (row.objetivos[i].priorizaciones[0].id == 1) {
                html += '<div class="d-flex justify-content-center align-items-start flex-column data-bs-html="true" data-bs-toggle="tooltip" title="ERIK">' + '<div class="text-primary fw-500 mep-5" id="' + row.objetivos[i].id + '" >' + row.objetivos[i].nombre + '<ion-icon name="star" class="text-warning  msp-5  data-bs-html="true" data-bs-toggle="tooltip" title="PEREDA" "></ion-icon>' + "</div></div>";
