...
$(function () {
  ...
  if (dt_filter_table.length) {
    ...
    var dt_filter = dt_filter_table.DataTable({
      ...
      columns: [{ data: "id" }, { data: "nombre" }, { data: "rut" }, { data: "correo" }, { data: "rol" }, { data: "colegio" }, { data: "estado" }, { data: "" }],
      columnDefs: [
        {
          // For Responsive
          className: "control",
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<div class="avatar-group">' + '<div data-popup="tooltip-custom" class="avatar pull-up my-0 ' + $status[$status_number].class + '" data-bs-toggle="tooltip" data-bs-placement="bottom" title="' + $status[$status_number].title + '">' + "</div></div>"
            );
          },
        },
        {
